<div
    ...
    <div class-="relative mb-12">
        ...
        <div class="text-center bg-white dark:bg-slate-800 relative z-10 py-9 px-3 rounded-lg shadow-lg mx-7 -mt-4 h-[260px]">
            <span class="text-sm text-orange3 dark:text-orange2 font-semibold block mb-2">
                {{ implode(", ", $categories) }}
            </span>
            <h3 class="font-bold text-lg text-dark dark:text-gray-300 mb-4">
                {{$title}}
            </h3>
            <x-button-link :href="$github" variant="outline-secondary">View Details</x-button-link>
        </div>
    </div>
</div>
