<div {{$attributes->class(['flex items-center'])}}>
    <a
        href="https://www.facebook.com/profile.php?id=100010140098259"
        target="_blank"
        class="
                     w-10
                     h-10
    ...
    <a
        href="https://www.youtube.com/channel/UCD0HwsaRmj_oV0AD7x77X1g"
        target="_blank"
        class="
                     w-10
                     h-10
    ...
    <a
        href="https://www.linkedin.com/in/jayden-fokkink-458611232/"
        target="_blank"
        class="
                     w-10
                     h-10
    ...
    <a
        href="https://www.instagram.com/jaydenfokkink/"
        target="_blank"
        class="
                     w-10
                     h-10
                     ...
                     "
    >
            <svg class="fill-current" fill="#ffffff" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 30 30" width="30px" height="30px">
