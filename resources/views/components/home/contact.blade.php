<section id="contact" class="bg-white dark:bg-primary py-20 lg:py-[120px] overflow-hidden relative z-10"
    ...
    <div class="container">
        <div class="flex flex-wrap lg:justify-between -mx-4">
            <div class="w-full lg:w-1/2 sl:w-6/12 px-4">
                <div class="max-w-[570px] mb-12 lg:mb-0">
                    ...
                    <p class="text-base text-body-color dark:text-gray-200 leading-relaxed mb-9">
                        If you are interested in my projects, feel free to contact me and ask about them.
                    </p>
                    <div class="flex mb-8 max-w-[370px] w-full">
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-base text-body-color dark:text-gray-300">jaydenfokkink@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
                <div class="bg-white dark:bg-slate-900 relative rounded-lg p-8 sm:p-12 shadow-lg">
                    ...
                    " x-on:submit.prevent="submitForm">
                        ...
                        @csrf
                        <div class="mb-6">
                            <x-forms.input placeholder="Your Name" none="name" x-model="formData.name"
                        ...
                        <div class="mb-6">
                            <x-forms.input type="email" placeholder="Your Email" none="email" x-model="formData.email"
                                           ::class="errors.name ? 'border-red-500 focus:border-red-500' : ''"></x-forms.input>
                            <template x-if="errors.name">
                                <div x-text="errors.name[0]" class="text-red-500"></div>
                            </template>
                        ...
                        <div class="mb-6">
                            <x-forms.textarea placeholder="Your Message" none="message" rows="6"
                                              x-model="formData.message"
                                              ::class="errors.name ? 'border-red-500 focus:border-red-500' : ''"></x-forms.textarea>
                            <template x-if="errors.name">
                                <div x-text="errors.name[0]" class="text-red-500"></div>
                            </template>
                        </div>
                    ...
                    <div>
                        <span class="absolute -top-10 -right-9 z-[-1]]">
                            <svg widht="100" heigt="100" viewBox="0 0 100 100" fill="none"
